...
def build_messages(config, history, user_message, terminal_instruction=None):
    ...
    if mode == MODE_CHARACTER:
        ...
        if not character:
            return None
        sections.append("You are chatting as the selected character. Follow the character profile.")
