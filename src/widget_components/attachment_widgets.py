"""Attachment widgets - image previews, attachment chips."""
...
class ImagePreviewButton(QPushButton):
    """Button displaying image thumbnail."""
...
class AttachmentChip(QFrame):
    """Chip displaying file attachment with remove/preview actions."""
...
class ImageGalleryDialog(QDialog):
    """Dialog for browsing multiple images."""
...
class FilePreviewDialog(QDialog):
    """Dialog for previewing file content."""
    ...
    def __init__(self, file_path, parent=None):
        ...
        self.text_browser.setDocumentMargins(12, 12, 12, 12)
        self.text_browser.document().setDefaultStyleSheet(MARKDOWN_STYLESHEET)
    ...
    def _load_content(self):
        ...
        if path.suffix.lower() in {".png", ".jpg", ".jpeg", ".gif", ".bmp", ".ico"}:
            ...
            try:
                ...
                self.text_browser.setPlainText("[Binary file]")
            except OSError:
                self.text_browser.setPlainText("[File not found]")